...
INSERT INTO menu_items (category, name, description, price, image) VALUES
  ...
  ('Beverages', 'Badam Milk', 'Authentic Indian Badam Milk prepared with traditional spices and fresh ingredients.', 160, 'https://images.unsplash.com/photo-1523677011781-c91d1bbe2f9d?w=500') ON CONFLICT (name) DO NOTHING;
